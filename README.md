...
API → DB (5432, private_net)

3. Host-based firewalling with iptables

db → api:5000 blocked intentionally
...
policy.json documents allowed flows
...
Python 3 (for connectivity testing)
